...
class Certs(object):
    ...
    def __init__(self, certificate_dir=None):
        ...
        required_paths = (self.cert_dir, self.private_dir, self.ca_db_dir,
                          self.csr_pending_dir, self.remote_cert_dir,
    ...
    def export_pkcs12(self, name, outfile):
        ...
        cmd = [
            "openssl", "pkcs12", "-export", "-out", outfile, "-in", cert_file,
            "-inkey", key_file,
        ]
    ...
    def save_agent_remote_info(self, directory, local_keyname,
                               remote_cert_name, remote_cert, remote_ca_name,
                               remote_ca_cert,
                               ):
        """
