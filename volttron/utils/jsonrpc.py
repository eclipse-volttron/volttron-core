...
__all__ = [
    "Error", "MethodNotFound", "RemoteError", "Dispatcher", "json_result",
    "json_validate_request", "json_validate_response",
]
    ...
    def _dispatch_one(self, msg, batch, context):
        ...
        if "error" in msg:
            ...
            try:
                ...
                return json_error(
                    ident, UNHANDLED_EXCEPTION,  # pylint: disable=star-args
