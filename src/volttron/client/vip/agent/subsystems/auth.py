...
class Auth(SubsystemBase):
    ...
    #                     remote_cert_name = "{}.{}".format(info._instance_name, fqid_local)
    ...
    #                         remote_rmq_user = cc.get_fq_identity(fqid_local, info._instance_name)
    ...
    #                             _instance_name=info._instance_name,
    #                             publickey=self._core().publickey,
    #                             secretkey=self._core().secretkey,
    #                             message_bus="rmq",
    #                             enable_store=False,
    ...
    #
    #     certs = Certs()
    #     csr_request = certs.create_csr(fully_qualified_local_identity, discovery_info._instance_name)
    ...
    #     remote_cert_name = "{}.{}".format(discovery_info._instance_name, fully_qualified_local_identity)
    #     remote_ca_name = discovery_info._instance_name + "_ca"
    #
