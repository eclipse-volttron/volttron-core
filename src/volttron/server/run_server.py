...
from volttron.utils import ClientContext as cc, execute_command, get_address, is_volttron_running
...
def start_volttron_process(options: ServerOptions):
    ...
    try:
        ...
        if not mb.is_running():
            sys.stderr.write("Messagebus did not start. Please check logs\n")
            sys.exit(1)
